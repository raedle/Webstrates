...
module.exports.UPLOAD_DEST = config.uploadsFolder;
...
module.exports.deleteAssetFromDatabase = (fileName) => {
	if (!fileName || fs.existsSync(path.join(module.exports.UPLOAD_DEST, fileName))) return;
...
const deleteAssetFromFileSystem = (fileName) => {
	...
	return unlink(path.join(module.exports.UPLOAD_DEST, fileName));
};
		...
		db.assets.distinct('fileName', {
			...
			assetsToBeDeleted.forEach(function(asset) {
				...
				promises.push(new Promise(function(resolve, reject) {
					const filePath = path.join(module.exports.UPLOAD_DEST, asset);
			...
			db.assets.insert({
				...
				if (searchable && asset.mimetype === 'text/csv') {
					...
					await searchableAssets.makeSearchable(assetId,
						path.join(module.exports.UPLOAD_DEST, asset.filename));
				}
